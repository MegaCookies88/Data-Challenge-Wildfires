...
# Prediction
prediction_ba_prob <- predict_ba_prob_gaussian_1(BAm1s, data_train_DF[-train_ind,])

# Score
S_BA_1s <- get_score_ba(prediction_ba_prob, data_train_DF[-train_ind,]$BA, u_ba, weights_ba)
cat("S_BA =", S_BA_1s)
